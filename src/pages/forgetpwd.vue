<template>
  <div class="public">
     <van-nav-bar title="找回密码" left-text="" left-arrow @click-left="back" />
    <!-- logo -->
    <div class="d_logo">
    ...
    <div class="content">
      <div class="login_info">
        ...
        <div class="log_pwd">
         ...
         <div class="log_pwd">
          <van-field type="password" v-model="login_pwd" maxlength="16" @blur="hintPassFun" clearable placeholder="请输入密码（6-16数字字母组合）" />
        </div>
        <div class="log_pwd">
          <van-field type="password"  v-model="re_login_pwd" maxlength="16"  @blur="hintRepassFun" clearable placeholder="请再次输入密码" />
        </div>

        <van-button type="primary" @click="changePass" size="large">修改</van-button>
      </div>
    </div>
