<template>
  <div class="public">
    <van-nav-bar title="交易密码" left-arrow @click-left="back" />
    <div class="content">
      <div class="login_info waiting">
        ...
        <van-field label="交易密码" type="password" v-model="login_pwd" maxlength="16" @blur="hintPassFun" clearable placeholder="请输入交易密码" />
        <van-field label="交易密码" type="password" v-model="re_login_pwd" maxlength="16"  @blur="hintRepassFun" placeholder="请再次输入交易密码" />
      </div>
      <!--  <p>
